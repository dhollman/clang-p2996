...
- Update `CXXTokenSequenceExpr` to store annotation tokens rather than generating placeholders in Sema
- Make proper `Expr` nodes for each of the interpolator types?
- Move some of the evaluation logic in `SemaReflect.cpp` to the constant evaluator in `ExprConstant.cpp`?
